...
description: Use when adding, importing, renaming, or reorganizing Skills and knowledge packs in this repository. Enforces SasukeTorii's naming policy, updates internal references, preserves required skill entrypoint filenames, and checks for stale paths before commit.
---
