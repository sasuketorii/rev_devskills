...
- Realtime Messages usage: https://supabase.com/docs/guides/platform/manage-your-usage/realtime-messages
- Realtime Peak Connections usage: https://supabase.com/docs/guides/platform/manage-your-usage/realtime-peak-connections
- Storage Image Transformations usage: https://supabase.com/docs/guides/platform/manage-your-usage/storage-image-transformations
- MAU usage: https://supabase.com/docs/guides/platform/manage-your-usage/monthly-active-users
- Third-Party MAU usage: https://supabase.com/docs/guides/platform/manage-your-usage/monthly-active-users-third-party
- PITR usage: https://supabase.com/docs/guides/platform/manage-your-usage/point-in-time-recovery
- IPv4 usage: https://supabase.com/docs/guides/platform/manage-your-usage/ipv4
- Custom Domain usage: https://supabase.com/docs/guides/platform/manage-your-usage/custom-domains
- Log Drains usage: https://supabase.com/docs/guides/platform/manage-your-usage/log-drains
- Advanced MFA Phone usage: https://supabase.com/docs/guides/platform/manage-your-usage/advanced-mfa-phone
...
## Japanese supplemental reading

日本語記事は実装例や事故パターンの把握に便利だが、価格・仕様の判断は公式Docsを優先する。
