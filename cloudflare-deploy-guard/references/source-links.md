...
仕様・価格は変更されるため、デプロイ前に必ず公式Docs、Pricing、Dashboard、MCP/Observabilityの現在値で再確認する。

## Official Cloudflare / OpenAI sources
...
事故例はリスク把握の補助として使う。価格・仕様・対策の最終判断は公式Docsを優先する。
