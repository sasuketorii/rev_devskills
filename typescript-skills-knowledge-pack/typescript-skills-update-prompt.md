...
このプロンプトは、ChatGPT / Claude / Gemini Deep Research / high-end WebUI model で TypeScriptSkills を更新するために使う。ユーザーの開発メモリがある場合は、Sasuke / REV-C Inc. / RustSkills / CCTeam / Social Psychometrics CRM / Web Builder / AI Agent / E2EE / 高負荷crawler に寄与するpackageだけを優先する。
